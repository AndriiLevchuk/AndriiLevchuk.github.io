...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            uploadButtonClass: "btn btn-big btn-red",
        ...
        (function checkAjaxFormLoaded() {
            if($.fn.ajaxForm) {
                ...
                if(s.dragDrop) {
                    ...
                    $(obj).append(dragDrop);
                    $('body').find('#buttons').append(uploadLabel);
                ...
                if(s.showQueueDiv)
                    ...
                    obj.container = $(".ajax-upload-dragdrop").append("<div class='ajax-file-upload-container'></div>");
